    ...
    const sendForm = async () => {
        ...
        const requestPay = {
            data: {
                ...
                razon_social: razon_social.length > 0 ? razon_social.toUpperCase() : fullname.toUpperCase(),
                direccion: address,
                celular: cellphone,
                costo_envio: 0,
                subtotal: 1000,
        ...
        const response = await fetch('https://www.dashboard.hauscenter.com.bo/api/ordens', {
            method: 'POST',
            headers: {
        ...
        if (response.status == 200) {
            try {
                ...
                const responseEmail = await fetch('https://www.email.hauscenter.com.bo/api/send-email')
                if (responseEmail.status == 200) {
                    router.push('/compra-realizada')
                }
            } catch (error) {
                alert('Ocurrio un error inesperado!... Vuelve a intentarlo en un momento.')
            }
        }
    }
        ...
        <div className="grid grid-cols-3 gap-6 m-8">
                ...
                <Card>
                    ...
                    <CardContent className="grid grid-cols-4 gap-6">
                        <div className=" col-span-2">
                            ...
                            <Input onChange={(event) => setFullName(event.target.value)} className="border-gray-800 border-opacity-40" id="fullname" placeholder="Ingresa tu nombre" />
                        </div>
                        <div className=" col-span-1">
                            <Label htmlFor="ci">CI</Label>
                            <Input onChange={(event) => setCi(event.target.value)} className="border-gray-800 border-opacity-40" id="ci" placeholder="Ingresa tu CI" />
                        </div>
                        <div className="col-span-1">
                            <Label htmlFor="extension">Extensión</Label>
                            <Select onValueChange={(value) => setExtension(value)}>
                        ...
                        <div className=" col-span-1">
                            ...
                            <Input onChange={(event) => setCellphone(event.target.value)} className="border-gray-800 border-opacity-40" id="cellphone" placeholder="+591 789 12 242" />
                        </div>
                        <div className=" col-span-1">
                            <Label htmlFor="email">Correo electrónico</Label>
                            <Input onChange={(event) => setEmail(event.target.value)} className="border-gray-800 border-opacity-40" id="email" placeholder="usuario@gmail.com" />
                        </div>
                        <div className=" col-span-2">
                            <Label htmlFor="address">Dirección</Label>
                            <Input onChange={(event) => setAddress(event.target.value)} className="border-gray-800 border-opacity-40" id="address" placeholder="Ingresa Dirección de tu domicilio" />
                        </div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Ingresa tus datos financiero para la factura de compra
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-3 gap-6">
                        <div className=" col-span-1">
                            <Label htmlFor="razonSocial">Razon social</Label>
                            <Input onChange={(event) => setRazonSocial(event.target.value)} className="border-gray-800 border-opacity-40" id="razonSocial" placeholder="Ingresa tu razon social" />
                        </div>
                        <div className=" col-span-1">
                            <Label htmlFor="nit">NIT</Label>
                            <Input onChange={(event) => setNit(event.target.value)} className="border-gray-800 border-opacity-40" id="nit" placeholder="Ingresa tu NIT" />
                        </div>
                    </CardContent>
                </Card>
                            ...
                            <CardContent className="grid gap-6">
                                <RadioGroup defaultValue={methodPay} className="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        >
                                            <Img baseUrl={false} url={"/credit-card-24.png"} qheight={45} qwidth={45} width={"20px"} height={"20px"} objectFit={"cover"} />
                                    ...
                                    <div>
                                        ...
                                        <Label
                                            ...
                                            className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                                        >
                                            <Img baseUrl={false} url={"/transfer-24.png"} qheight={45} qwidth={45} width={"20px"} height={"20px"} objectFit={"cover"} />
                                    ...
                                    <div>
                                        ...
                                        <Label
                                            ...
                                            className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                                        >
                                            <Img baseUrl={false} url={"/qr-24.png"} qheight={45} qwidth={45} width={"20px"} height={"20px"} objectFit={"cover"} />
                    ...
                    <div className="col-span-1">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Seleccione un método para establecer el envio de su producto.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="grid gap-6">
                                <RadioGroup defaultValue={methodDelivery} className="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <Label
                                            ...
                                            className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                                        >
                                            <Img baseUrl={false} url={"/fast-shipping-32.png"} qheight={45} qwidth={45} width={"20px"} height={"20px"} objectFit={"cover"} />
                                    ...
                                    <div>
                                        ...
                                        <Label
                                            ...
                                            className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                                        >
                                            <Img baseUrl={false} url={"/lightning-32.png"} qheight={45} qwidth={45} width={"20px"} height={"20px"} objectFit={"cover"} />
            ...
            <div className="col-span-1 space-y-6">
                <Card>
                        ...
                        {products.map((product: any) => (
                            <div key={product.id} className="grid grid-cols-4">
                                <div className="col-span-1 flex justify-center items-center">
                                    <Img url={product.imagen} width={"80px"} height={"80px"} objectFit={"cover"} />
                                </div>
                                <div className="col-span-2">
                                ...
                                <div className="col-span-1 flex justify-end items-center pr-8">
                                    <span className="text-primary font-extrabold">{product.precio} Bs</span>
                                </div>
                            </div>
                        ))}
                        <div className="grid grid-cols-4 px-8 mt-4">
                            <div className="col-span-3">
                                <p className=" font-bold text-primary text-lg">Costo de envio</p>
                            </div>
                    ...
                    <CardFooter>
                        <Button onClick={sendForm} className="w-full">Completar compra</Button>
                    </CardFooter>
